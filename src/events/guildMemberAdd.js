...
Hoşgeldin  ${member} Seninle birlikte sunucumuz \`${member.guild.memberCount}\` kişiyiz  
        
Hesabını \`(${moment(member.createdAt).format("DD MM YY・HH:mm:ss")})\` Tarhi `+kontrol+`

Kurallar sunucunun düzenini sağlamak için konulmuştur <#> kanalından kurallarımızı okumayı ihmal etme. <@&>
